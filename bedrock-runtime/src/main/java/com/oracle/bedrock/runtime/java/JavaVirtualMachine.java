...
public class JavaVirtualMachine extends AbstractPlatform
{
    ...
    /**
     * Set whether {@link JavaApplication}s started from Bedrock will automatically
    ...
    /**
     * Obtain the flag indicating whether {@link JavaApplication}s started from Bedrock
    ...
    /**
     * Returns true if {@link JavaApplication}s started from Bedrock
     * should run with remote debugging enabled.
     *
     * @return true if {@link JavaApplication}s started from Bedrock
     *         should run with remote debugging enabled.
     */
