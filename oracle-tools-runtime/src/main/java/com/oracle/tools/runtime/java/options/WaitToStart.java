...
public class WaitToStart implements Option
{
     ...
     *
     * @param enabled  when true, Oracle Tools will wait for an application to start,
     *                 otherwise it won't
     */
    ...
    /**
     * Determine if Oracle Tools must wait for an application to start.
     *
     * @return  <code>true</code> when Oracle Tools must wait for an application to start,
