 ...
 */
@Deprecated
public abstract class AbstractApplicationGroup<A extends Application> extends AbstractAssembly<A>
    implements ApplicationGroup<A>
{
    /**
     ...
     */
    public AbstractApplicationGroup(List<? extends A> applications)
    {
        super(applications);
    }
