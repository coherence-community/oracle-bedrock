 ...
 * implementation for the StdOut {@link OutputStream} of a {@link VirtualizedSystem}.
 * <p>
...
public class DelegatingStdOutOutputStream extends AbstractDelegatingOutputStream
{
     ...
     *                      {@link VirtualizedSystem} can't be determined
     */
     ...
     */
    @Override
    public OutputStream getOutputStreamFor(VirtualizedSystem system)
    {
        return system.getStdOut();
    }
}
