...
/**
 * A {@link Reader} that produces nothing (is always at the end of the stream).
 * <p>
...
public class NullReader extends Reader
{
                    ...
                    int    length) throws IOException
    {
        ...
        return -1;    // we're at the end of the stream
    }
}
