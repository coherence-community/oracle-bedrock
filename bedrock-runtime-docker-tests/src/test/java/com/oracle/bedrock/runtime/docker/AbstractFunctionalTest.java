...
public class AbstractFunctionalTest
{
     ...
     */
    public static final String javaImageName = "bedrockjava:1.0";
    ...
    {
        String installer = System.getProperty("oracle.bedrock.container.tests.jre");

        Assume.assumeThat("Could not create Java image: No oracle.bedrock.container.tests.jre property set " +
                          "pointing to a JRE tar.gz file",
                          installer, is(notNullValue()));

        Assume.assumeThat("Could not create Java image: The oracle.bedrock.container.tests.jre " +
        ...
        Assume.assumeThat("Could not create Java image: The installer file pointed to by the property " +
                          "oracle.bedrock.container.tests.jre does not exist: " + installer,
                          installerFile.exists(), is(true));

        Assume.assumeThat("Could not create Java image: The installer file pointed to by the property " +
                          "oracle.bedrock.container.tests.jre is not a File: " + installer,
