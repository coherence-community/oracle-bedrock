...
/**
 * An implementation of a {@link com.oracle.tools.runtime.java.JavaApplication} that runs
...
public class SimpleJUnitTestRun extends SimpleJavaApplication implements JUnitTestRun
{
    ...
    public SimpleJUnitTestRun(Platform platform, JavaApplicationProcess process, Options options)
    {
        ...
        for (JUnitTestListener listener : options.getInstancesOf(JUnitTestListener.class))
        {
    ...
    @Override
    public void startTests(Options options)
    {
        submit(new JUnitTestRunner.StartTests(options));
    }
