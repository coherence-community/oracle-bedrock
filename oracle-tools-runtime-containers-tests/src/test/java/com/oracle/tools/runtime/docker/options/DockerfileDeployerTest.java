...
public class DockerfileDeployerTest
{
    ...
    public void shouldWriteAddList() throws Exception
    {
        ...
        assertThat(addLines.get(0), is(equalToIgnoringWhiteSpace("ADD file1.txt /foo/file1.txt")));
        assertThat(addLines.get(1), is(equalToIgnoringWhiteSpace("ADD file2.txt /bar/test.txt")));
        assertThat(addLines.get(2), is(equalToIgnoringWhiteSpace("ADD file3.txt /foo/file3.txt")));
    }
