...
{
    /**
     * Create a {@link HelmGetManifest} command.
     *
     * @param releaseName  the release to get
     */
    HelmGetManifest(String releaseName)
    {
     ...
     */
    HelmGetManifest(String helm, Arguments arguments, Arguments flags, EnvironmentVariables env)
    {
        super(helm, arguments, flags, env, true, "get", "manifest");
    }
    ...
    @Override
    public HelmGetManifest newInstance(String helm, Arguments arguments, Arguments flags, EnvironmentVariables env)
    {
        return new HelmGetManifest(helm, arguments, flags, env);
    }
}
