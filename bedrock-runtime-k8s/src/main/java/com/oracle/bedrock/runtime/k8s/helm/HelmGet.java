...
public class HelmGet
        extends HelmCommand<HelmGet>
        implements CLI.WithTLS<HelmGet>
{
    /**
     * Create a {@link HelmGet} command.
     *
     * @param releaseName  the release to get
     */
    HelmGet(String releaseName)
    {
     ...
     */
    HelmGet(String helm, Arguments arguments, Arguments flags, EnvironmentVariables env)
    {
        super(helm, arguments, flags, env, true, "get");
    }
    ...
    @Override
    public HelmGet newInstance(String helm, Arguments arguments, Arguments flags, EnvironmentVariables env)
    {
        return new HelmGet(helm, arguments, flags, env);
    }
}
