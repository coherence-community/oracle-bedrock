...
import com.oracle.tools.runtime.docker.options.ContainerCloseBehaviour;
...
public class DockerNetworkTest extends AbstractFunctionalTest
{
     ...
     */
    private static final String javaImageName = "oracletoolsjava:1.0";
    ...
    public static void createPlatform() throws Exception
    {
        ...
        keystorePlatform     = createKeystorePlatform(docker,
                                                      machine,
                                                      keystorePlatformName);
    ...
    public void shouldCreateAndRemoveNetwork() throws Exception
    {
        ...
        Application                 list    = platformOne.launch(Network.list()
                                                                        .filter("name=my-net"),
                                                                 Console.of(console));

        assertThat(list.waitFor(), is(0));

        String line = console.getCapturedOutputLines()
                             .stream()
                             .filter((l) -> l.contains("my-net"))
                             .findFirst()
                             .orElse(null);
    ...
    public void shouldRunApplicationAndConnectToDefaultNetwork() throws Exception
    {
                                                             ...
                                                             Argument.of(60)))
        {
            ...
            List<String> names          = jsonContainers.values()
                                               .stream()
                                                               ...
                                                               String        name)
    {
        ...
        try (Application keystoreContainer = platform.launch(Run.image("progrium/consul", "consul")
                                                                .detached()
                                                                .hostName("consul")
                                                                .publish("8500:8500"),
     ...
     */
    public static void pullBaseImage(DockerMachinePlatform platform, String imageName)
    {
