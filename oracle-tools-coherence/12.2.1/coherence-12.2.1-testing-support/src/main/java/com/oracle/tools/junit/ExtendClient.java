...
public class ExtendClient implements SessionBuilder
{
                                          ...
                                          Option...                     options)
    {
        ...
        launchOptions.add(Clustering.disabled());
        launchOptions.add(SystemProperty.of("coherence.profile", "thin"));
        launchOptions.add(SystemProperty.of("coherence.client", "remote"));
